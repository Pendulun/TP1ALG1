...
$(BUILD)$(JOGO)Jogo.o: $(SRC)$(JOGO)Jogo.cpp $(INCLUDE)$(JOGO)Jogo.hpp $(INCLUDE)$(JOGO)Jogador.o $(INCLUDE)$(JOGO)Node.o 
	$(CC) $(CFLAGS) -I $(INCLUDE)$(JOGO) -c $(SRC)$(JOGO)Jogo.cpp -o $(BUILD)$(JOGO)Jogo.o

$(BUILD)$(JOGO)Jogador.o: $(SRC)$(JOGO)Jogador.cpp $(INCLUDE)$(JOGO)Jogador.hpp $(INCLUDE)$(JOGO)Posicao.o 
	$(CC) $(CFLAGS) -I $(INCLUDE)$(JOGO) -c $(SRC)$(JOGO)Jogador.cpp -o $(BUILD)$(JOGO)Jogador.o

$(BUILD)$(JOGO)Node.o: $(SRC)$(JOGO)Node.cpp $(INCLUDE)$(JOGO)Node.hpp $(INCLUDE)$(JOGO)Posicao.o 
